# Tilly autonomous test run -- 2026-04-28T12:02:38.329Z

Live deployment: https://buildtogether-v2.vercel.app

**29 pass / 0 fail / 4 skip / 33 total**

| ID | Scenario | Result | Note |
| --- | --- | --- | --- |
| 1.1 | health endpoint | PASS | version=c7a7491 provider=openrouter |
| 1.2 | web app loads sign-in screen | PASS | screenshot 01-signin.png |
| 2.1 | register works | PASS | email=tilly-test-1777377599153@example.com |
...
| 2.4-name | onboarding name card | PASS | screenshot 03 |
| 2.4-bank | onboarding bank card | PASS | screenshot 04 |
| 2.4-dream | onboarding dream card | PASS | screenshot 05 |
| 2.4-commit | onboarding commit card | PASS | screenshot 06 |
| 2.4 | onboarding completes via UI | PASS | hasCompletedOnboarding=true |
...
| 2.8 | memory inspector opens | PASS | screenshot 10 |
...
| 3.1 | POST /api/dreams creates a dream | PASS | id=8cbe45fd-fbcf-41d5-ae4b-9f2174c27cc0 |
